...
const transferFunds = () => {
  const {currentAccount, transferEther, loading, accountBalance} = useContext(NFTMarketplaceContext);
    ...
    <div className={Style.transfer}>
      <div className={Style.transfer_box}>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
          Vestibulum aliquam eleifend ex, quis faucibus orci lobortis in. 
          Sed accumsan nisl in urna condimentum, maximus dictum leo pellentesque. Sed porta quis erat vitae vulputate
        </p>
        <div className={Style.transfer_box_box}>
          <div className={Style.transfer_box_box_left}>
            <Image 
            src={images.transferFunds} 
            alt="images" 
            width={400} 
            height={400}/>
          </div>
          <div className={Style.transfer_box_box_right}>
            ...
            <div className={Style.transfer_box_box_right_box}>
              ...
              {loading ? (
                ...
                <Button btnName="Transfer Funds" handleClick={() => 
            ...
            transactions.map((el, i)=> (
              <div className={Style.transfer_box_history_item} key={i + 1}>
                ...
                <div className={Style.transfer_box_history_item_info}>
                  <p><span>Transfer ID:</span> #1</p>
                  <p><span>Amount:</span> #1</p>
                  <p><span>From:</span> #1</p>
                  <p><span>To:</span> #1</p>

                  <Button 
                    btnName="Message" 
                    handleClick={(()=>(setMessage("ahaha"), setOpenBox(true)))
